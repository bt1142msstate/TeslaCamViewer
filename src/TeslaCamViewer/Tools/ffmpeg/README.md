...
The development machine may contain FFmpeg binaries under
`src/TeslaCamViewer/Tools/ffmpeg/bin`, but those binaries are intentionally
ignored by Git to keep the public repository source-focused and avoid
committing large generated/runtime artifacts.
