...
- [Download Windows setup (recommended)](https://github.com/bt1142msstate/TeslaCamViewer/releases/download/v0.1.0-preview.7/TESLA-Cam-win-x64-Setup.exe)
- [Download portable ZIP](https://github.com/bt1142msstate/TeslaCamViewer/releases/download/v0.1.0-preview.7/TESLA-Cam-win-x64-portable.zip)
- [Download PowerShell fallback script](https://github.com/bt1142msstate/TeslaCamViewer/releases/download/v0.1.0-preview.7/Install-TESLA-Cam.ps1)
- [Download cleanup/uninstall script](https://github.com/bt1142msstate/TeslaCamViewer/releases/download/v0.1.0-preview.7/Uninstall-TESLA-Cam.ps1)
- [View checksums](https://github.com/bt1142msstate/TeslaCamViewer/releases/download/v0.1.0-preview.7/SHA256SUMS.txt)
